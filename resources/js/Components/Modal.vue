        ...
        <div class="fixed inset-0 z-50 overflow-y-auto px-4 py-6 sm:px-0" scroll-region>
            ...
            >
                <div v-show="show" class="fixed inset-0 transform transition-all" @click="close">
                    <div class="bg-ink absolute inset-0 opacity-75" />
                </div>
            </Transition>
            ...
            >
                <div
                    v-show="show"
                    class="bg-raised mb-6 transform overflow-hidden rounded-[--radius-ui] shadow-xl transition-all sm:mx-auto sm:w-full"
                    :class="maxWidthClass"
                >
                    <slot v-if="showSlot" />
                </div>
